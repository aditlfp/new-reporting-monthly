...
style="transform: translateX(-100%)"
    ...
    <nav class="flex-1 p-4 space-y-6">
        ...
        <div class="space-y-1">
            ...
            @if (stripos(auth()->user()->jabatan->type_jabatan, 'leader') !== false || stripos(auth()->user()->jabatan->name_jabatan, 'leader') !== false || stripos(auth()->user()->jabatan->type_jabatan, 'MANAJEMEN') !== false || stripos(auth()->user()->jabatan->code_jabatan, 'CO-CS') !== false || stripos(auth()->user()->jabatan->code_jabatan, 'CO-SCR') !== false)
