...
<body class="overflow-x-hidden bg-gray-50">
    ...
    <main>
        ...
        <!-- Preview Section -->
        <section class="py-20 bg-white md:py-32" id="preview">
            <div class="container px-4 mx-auto">
                <div class="mb-16 text-center fade-up">
                    <span class="text-sm font-semibold tracking-wider text-purple-600 uppercase">Preview Sistem</span>
                    <h2 class="mt-4 mb-6 text-4xl font-black md:text-5xl lg:text-6xl">
                ...
                <div class="max-w-6xl mx-auto mb-20 slide-in-left">
                    <div class="flex items-center gap-3 mb-8">
                        <div class="flex items-center gap-2 px-4 py-2 text-white rounded-full shadow-lg bg-gradient-to-r from-purple-600 to-indigo-700">
                            <i class="text-xl ri-admin-line"></i>
                    ...
                    <div class="grid gap-6 mt-8 md:grid-cols-3">
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-purple-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">Real-time Statistics</h4>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-purple-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">Activity Timeline</h4>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-purple-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">Analytics Dashboard</h4>
                ...
                <div class="max-w-6xl mx-auto slide-in-right">
                    <div class="flex items-center gap-3 mb-8">
                        <div class="flex items-center gap-2 px-4 py-2 text-white rounded-full shadow-lg bg-gradient-to-r from-pink-500 to-rose-600">
                    ...
                    <div class="grid gap-6 mt-8 md:grid-cols-3">
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-pink-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">3-Step Upload</h4>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-pink-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">Limit Tracker</h4>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="text-2xl text-pink-600 ri-checkbox-circle-fill"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-gray-800">Gallery View</h4>
